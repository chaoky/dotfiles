...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    for name in "aw-server-rust" "aw-watcher-afk" "aw-watcher-window"; do
    ...
    cp $installed/media/logo/logo.png $out/share/icons/hicolor/512x512/apps/activitywatch.png
    mkdir -p $out/share/icons/hicolor/128x128/apps
    cp $installed/media/logo/logo-128.png $out/share/icons/hicolor/128x128/apps/activitywatch.png
  '';
}
