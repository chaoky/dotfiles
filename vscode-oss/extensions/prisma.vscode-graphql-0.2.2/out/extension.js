...
function getEnvironment() {
    ...
    vscode_1.workspace.workspaceFolders.forEach(folder => {
        ...
        if (fs.existsSync(envPath)) {
            workspaceEnv = Object.assign({}, workspaceEnv, dotenv.parse(fs.readFileSync(envPath)));
        }
    });
    return Object.assign({}, workspaceEnv, process.env);
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let serverOptions = {
            ...
            debug: {
                module: serverModule,
                transport: vscode_languageclient_1.TransportKind.ipc,
                options: Object.assign({}, (debug ? debugOptions : {}), { env: combinedEnv })
            }
        };
        let clientOptions = {
            documentSelector: [
